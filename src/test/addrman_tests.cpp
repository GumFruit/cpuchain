...
BOOST_AUTO_TEST_CASE(addrman_simple)
{
    ...
    BOOST_CHECK_EQUAL(addr_ret1.ToString(), "250.1.1.1:19706");
...
BOOST_AUTO_TEST_CASE(addrman_ports)
{
    ...
    BOOST_CHECK_EQUAL(addr_ret2.ToString(), "250.1.1.1:19706");
    ...
    BOOST_CHECK_EQUAL(addr_ret3.ToString(), "250.1.1.1:19706");
}
...
BOOST_AUTO_TEST_CASE(addrman_find)
{
    ...
    CAddress addr3 = CAddress(ResolveService("251.255.2.1", 19706), NODE_NONE);
    ...
    BOOST_REQUIRE(info1);
    BOOST_CHECK_EQUAL(info1->ToString(), "250.1.2.1:19706");
    ...
    BOOST_REQUIRE(info3);
    BOOST_CHECK_EQUAL(info3->ToString(), "251.255.2.1:19706");
}
...
BOOST_AUTO_TEST_CASE(addrman_create)
{
    ...
    BOOST_CHECK_EQUAL(pinfo->ToString(), "250.1.2.1:19706");

    CAddrInfo* info2 = addrman.Find(addr1);
    BOOST_CHECK_EQUAL(info2->ToString(), "250.1.2.1:19706");
}
