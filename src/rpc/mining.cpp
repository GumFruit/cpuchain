...
static RPCHelpMan generatetoaddress()
{
    return RPCHelpMan{"generatetoaddress",
            ...
            + "If you are using the " PACKAGE_NAME " wallet, you can get a new address to send the newly generated cpuchainto with:\n"
...
// NOTE: Unlike wallet RPC (which use CPU values), mining RPCs follow GBT (BIP 22) in using satoshi amounts
