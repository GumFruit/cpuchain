...
class BumpFeeTest(BitcoinTestFramework):
    ...
    def test_invalid_parameters(self, rbf_node, peer_node, dest_address):
        ...
        for mode in ["foo", Decimal("3.1415"), "sat/B", "CPU/kB"]:
...
def test_dust_to_fee(self, rbf_node, dest_address):
    ...
    # Expected fee is 141 vbytes * fee_rate 0.00350250 CPU / 1000 vbytes = 0.00049385 CPU.
    # or occasionally 140 vbytes * fee_rate 0.00350250 CPU / 1000 vbytes = 0.00049035 CPU.
    # Dust should be dropped to the fee, so actual bump fee is 0.00050000 CPU.
...
def test_maxtxfee_fails(self, rbf_node, dest_address):
    ...
    # expected bump fee of 141 vbytes * 0.00200000 CPU / 1000 vbytes = 0.00002820 CPU
